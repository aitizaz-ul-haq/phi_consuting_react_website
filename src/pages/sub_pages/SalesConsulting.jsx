...
const SalesConsulting = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("http://64.23.206.154:3000/gtmpage");
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Craft dynamic Go-To-Market strategies with Phi Consulting. Propel your business forward with proven methodologies for successful product launches and market penetration. Partner with us today!"
        />
      </Helmet>
      <Helmet>
        <link
          rel="canonical"
          href="https://phiconsulting.org/solutions/go-to-market-strategy"
        />
      </Helmet>
        ...
        <section class="hero-container-sales">
          <div class="hero-content-sales">
            <h1 class="hero-heading-sales">
              {windowWidth >= 1200 ? (
                <TypeAnimation
                  sequence={["Your Gateway to Strategic GTM Consultancy", 7000]}
                  wrapper="span"
                  speed={50}
            ...
            <p class="hero-desc-sales">{data.bannerDescription}</p>
            <div class="consult-button-sales">
              {" "}
        ...
        <div class="sales-banner-container">
          <div class="sales-cards one-with-white-back">
            <div class="icon-container">
              <img src={salesone} alt="" width="90" height="90" />
            </div>
          ...
          <div class="sales-cards one-with-blue-back">
            <div class="icon-container">
              <img src={salestwo} alt="" width="90" height="90" />
            </div>
          ...
          <div class="sales-cards one-with-white-back">
            <div class="icon-container">
              <img src={salesthree} alt="" width="90" height="90" />
            </div>
      ...
      <article className="calcualtor-container">
        ...
        <section className="calculator-section">
          <div className="left-button-row">
            <button
              className={`cal-button-wide ${
                activeCalculator === "CAC" ? "cal-button-active" : ""
              }`}
              onClick={showCAC}
            >
              CAC
            ...
            <button
              className={`cal-button-wide ${
                activeCalculator === "CSR" ? "cal-button-active" : ""
              }`}
              onClick={showCSR}
            >
              CSR
            ...
            <button
              className={`cal-button-wide ${
                activeCalculator === "SDR" ? "cal-button-active" : ""
              }`}
              onClick={showSDR}
            >
              SDR
