...
const AddInv = () => {
  ...
  const onFinish = async (values) => {
    ...
    try {
      ...
      message.error('An error occurred while adding the invpage entry');
    }
  };

  if (redirectToCases) {
    return <Navigate to="/dashboard/inv" />;
  }

  return (
    <div className="form-container-dash">
      <Title level={2} style={{ fontWeight: 100, fontSize: '32px' }}>Add Investor Relation Page Content</Title>
