...
const AddHr = () => {
  ...
  const onFinish = async (values) => {
    ...
    try {
      const response = await axios.post('https://prickle-balanced-archaeopteryx.glitch.me/hrpage', values);
  ...
  return (
    <div className="form-container-dash">
      <Title level={2} style={{ fontWeight: 100, fontSize: '32px' }}>Add HR Page Content</Title>
