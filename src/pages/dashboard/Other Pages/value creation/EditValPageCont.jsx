...
const EditValPageCont = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`https://prickle-balanced-archaeopteryx.glitch.me/valuecreationpage/${valuecreationpageId}`);
                console.log(response.data);
                form.setFieldsValue(response.data);
            } catch (error) {
                console.error('Error fetching data:', error);
                message.error('An error occurred while fetching valuecreationpage data');
            }
        };
    ...
    const onFinish = async (values) => {
        try {
            await axios.put(`https://prickle-balanced-archaeopteryx.glitch.me/valuecreationpage/${valuecreationpageId}`, values);
