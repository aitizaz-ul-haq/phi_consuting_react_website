    ...
    >
      <Card style={{ width: "60%" }}>
        ...
        >
          ...
          <Form.Item
            name="nuggetoneheading"
            label="Nugget One Heading"
            rules={[{ required: true }]}
          >
            <Input />
          </Form.Item>
          ...
          <Form.Item
            name="nuggetonedescription"
            label="Nugget One Description"
            rules={[{ required: true }]}
          >
            <Input.TextArea />
          </Form.Item>
          ...
          <Form.Item
            name="nuggettwoheading"
            label="Nugget Two Heading"
            rules={[{ required: true }]}
          >
            <Input />
          </Form.Item>
          <Form.Item
            name="nuggettwodescription"
            label="Nugget Two Description"
            rules={[{ required: true }]}
          >
            <Input.TextArea />
          </Form.Item>
          ...
          <Form.Item
            name="nuggetthreeheading"
            label="Nugget Three Heading"
            rules={[{ required: true }]}
          >
            <Input />
          </Form.Item>
          <Form.Item
            name="nuggetthreedescription"
            label="Nugget Three Description"
            rules={[{ required: true }]}
          >
            <Input.TextArea />
          </Form.Item>
          ...
          <Form.Item
            name="nuggetfourheading"
            label="Nugget Four Heading"
            rules={[{ required: true }]}
          >
            <Input />
          </Form.Item>
          <Form.Item
            name="nuggetfourdescription"
            label="Nugget Four Description"
            rules={[{ required: true }]}
          >
            <Input.TextArea />
          </Form.Item>
          ...
          <Form.Item
            name="careerctaheading"
            label="Career Cta Heading"
            rules={[{ required: true }]}
          >
            <Input />
          </Form.Item>
          <Form.Item
            name="careerctadescription"
            label="Career Cta Description"
            rules={[{ required: true }]}
          >
            <Input.TextArea />
          </Form.Item>
