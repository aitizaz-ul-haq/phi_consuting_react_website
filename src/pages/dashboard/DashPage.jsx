  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        // Fetch industry data
        const industryApis = [
          "https://backend.phiconsulting.org/iot",
          "https://backend.phiconsulting.org/cloud",
          "https://backend.phiconsulting.org/devops",
          "https://backend.phiconsulting.org/iaas",
          "https://backend.phiconsulting.org/saas",
        ];
        const industryPromises = industryApis.map((api) =>
