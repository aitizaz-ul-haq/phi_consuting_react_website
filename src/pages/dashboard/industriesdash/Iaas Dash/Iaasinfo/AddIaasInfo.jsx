...
const AddIaasInfo = () => {
  ...
  const onFinish = async (values) => {
    ...
    try {
      ...
      message.error('An error occurred while adding the iaasinfo info entry');
    }
  };

  if (redirectToCases) {
    return <Navigate to="/dashboard/ShowIaasInfo" />;
  }
    return(
        <div className="form-container-dash">
        <Title level={2} style={{ fontWeight: 100, fontSize: '32px' }}>Add Iaas Information</Title>
