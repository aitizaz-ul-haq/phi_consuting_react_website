...
const IndustriesData = () => {
    ...
    useEffect(() => {
        const fetchIndustryData = async () => {
            setLoading(true);
            const industryApis = [
                { url: 'https://prickle-balanced-archaeopteryx.glitch.me/iot', name: 'IoT' },
                { url: 'https://prickle-balanced-archaeopteryx.glitch.me/cloud', name: 'Cloud' },
                { url: 'https://prickle-balanced-archaeopteryx.glitch.me/devops', name: 'DevOps' },
                { url: 'https://prickle-balanced-archaeopteryx.glitch.me/iaas', name: 'IaaS' },
                { url: 'https://prickle-balanced-archaeopteryx.glitch.me/saas', name: 'SaaS' },
            ];
