...
const DevopsBarCardSection = React.lazy(() =>
  import(
    "../../components/Industries_page_componenets/Devops/Devops BarCard Section/DevopsBarCardSection"
  )
);
const DevopsFourCardSection = React.lazy(() =>
  import(
    "../../components/Industries_page_componenets/Devops/Devops FourCard Section/DevopsFourCardSection"
  )
);
const DevopsCtaSection = React.lazy(() =>
  import(
    "../../components/Industries_page_componenets/Devops/Devops Cta Section/DevopsCtaSection"
  )
);
...
const DevopsWhyPhiForSales = React.lazy(() =>
  import(
    "../../components/Industries_page_componenets/Devops/Devops WhyPhiForSales Section/DevopsWhyPhiForSales"
  )
);
  ...
  const fetchSaasCards = async () => {
    try {
      const response = await axios.get(
        "https://backend.phiconsulting.org/devcards"
      );
