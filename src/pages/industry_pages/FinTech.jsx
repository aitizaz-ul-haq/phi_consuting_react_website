...
const FintechBarCardSection = React.lazy(() =>
  import(
    "../../components/Industries_page_componenets/FinTech/Fintech BarCard Section/FintechBarCardSection"
  )
);
const FintechFourCardSection = React.lazy(() =>
  import(
    "../../components/Industries_page_componenets/FinTech/Fintech FourCard Section/FintechFourCardSection"
  )
);
const IndustriesArticles = React.lazy(() =>
  import("../../components/shared/macroComps/IndustriesArticles")
);
const FintechCtaSection = React.lazy(() =>
  import(
    "../../components/Industries_page_componenets/FinTech/Fintech Cta Section/FintechCtaSection"
  )
);
...
const FintechWhyPhiForSales = React.lazy(() =>
  import(
    "../../components/Industries_page_componenets/FinTech/Fintech WhyPhiForSales Section/FintechWhyPhiForSales"
  )
);
