...
const IotBarCardSection = React.lazy(() =>
  import(
    "../../components/Industries_page_componenets/Iot/Iot BarCard Section/IotBarCardSection"
  )
);
const IotFourCardSection = React.lazy(() =>
  import(
    "../../components/Industries_page_componenets/Iot/Iot FourCard Section/IotFourCardSection"
  )
);
const IotCtaSection = React.lazy(() =>
  import(
    "../../components/Industries_page_componenets/Iot/Iot Cta Section/IotCtaSection"
  )
);
...
const IotWhyPhiForSales = React.lazy(() =>
  import(
    "../../components/Industries_page_componenets/Iot/Iot WhyPhiForSales Section/IotWhyPhiForSales"
  )
);
...
const Iot = () => {
  ...
  const fetchSaasCards = async () => {
    try {
      const response = await axios.get("http://64.23.206.154:3000/iotcards");
  ...
  useEffect(() => {
    const fetchCloudBanData = async () => {
      try {
        const response = await axios.get(`http://64.23.206.154:3000/iotban`);
