  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Drive growth with Phi Consulting's expert solutions in GTM Strategy, HR, Investor Relations & Financial Consulting. Maximize your enterprise potential. Schedule a free consultation now!"
        />
      </Helmet>
      <Helmet>
      ...
      <article class="process-new">
        ...
        <section class="process-new-container">
          ...
          <p class="work-desc">{data.servicesPathDescription}</p>
            ...
            <div class="left-process-section" ref={processNewRef}>
              ...
              >
                ...
                <div class="text-container">
                  <div class="process-new-heading">
                    {data.processOneHeading}
                  </div>
