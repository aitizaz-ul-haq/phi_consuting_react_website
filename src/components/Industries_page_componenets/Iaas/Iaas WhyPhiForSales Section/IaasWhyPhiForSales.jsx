...
const IaasWhyPhiForSales = ({ sectionOneTitle, sectionOneParagraph, sectionTwoTitle, sectionTwoParagraph, sectionThreeTitle, sectionThreeParagraph, sectionFourTitle, sectionFourParagraph }) => {
...
export default IaasWhyPhiForSales;
