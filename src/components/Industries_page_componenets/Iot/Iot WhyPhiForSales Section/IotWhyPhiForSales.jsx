...
const IotWhyPhiForSales = ({ sectionOneTitle, sectionOneParagraph, sectionTwoTitle, sectionTwoParagraph, sectionThreeTitle, sectionThreeParagraph, sectionFourTitle, sectionFourParagraph }) => {
...
export default IotWhyPhiForSales;
